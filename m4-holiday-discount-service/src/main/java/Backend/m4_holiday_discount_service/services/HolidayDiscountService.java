...
public class HolidayDiscountService {
    ...
    public boolean isHoliday(LocalDate date) {
        ...
        return (month == 1 && day == 1) ||     //1 de enero (año nuevo)
                (month == 4 && day == 18) ||   // 18 de abril (pascua)
                (month == 4 && day == 19) ||   // 19 de abril (pascua)
                (month == 5 && day == 10) ||   // 10 de mayo (dia de la madre)
                (month == 9 && day == 18) ||   // 18 de septiembre (fiestas patrias)
                (month == 9 && day == 19) ||   // 19 de septiembre (fiestas patrias)
                (month == 11 && day == 1) ||   // 1 de noviembre   (halloween)
                (month == 12 && day == 25);    // 25 de diciembre   (navidad)
    }

    //metodo que aplica un descuento al precio de la reserva si la fecha de la reserva es un dia festivo
    //utiliza el metodo isHoliday para determinar si la fecha es festiva
